...
import type { FindManyNearbyGymsParams, GymsRepository } from "../gym.repository.js";
...
export class PrismaGymRepository implements GymsRepository {
    ...
    async findManyNearby({ latitude, longitude }: FindManyNearbyGymsParams): Promise<Gym[]> {
